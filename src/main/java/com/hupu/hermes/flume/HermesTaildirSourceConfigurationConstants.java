...
public class HermesTaildirSourceConfigurationConstants {
    /**
    ...
    public static final int DEFAULT_WRITE_POS_INTERVAL = 1000;
    ...
    public static final int MAX_MSG_BYTES = 1024 * 50;

    public static final int IGNORE_MSG_BYTES = 1024 * 100;
}
